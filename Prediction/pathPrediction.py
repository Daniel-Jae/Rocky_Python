...
class PathPrediction:
    ...
    def predictPath(self):
        ...
        # Puck moves towards human
            ...
            remaining_distance = predicted_y - (
                self.center_new[1] - constants.PUCK_RADIUS
            )
    ...
    def draw_predicted_path(self):
        ...
        while True:
            ...
            start_point = self.center_new - constants.PUCK_RADIUS

            if predicted_x is None:
                continue
            else:
                bounces = math.floor(predicted_x / constants.FIELD_WIDTH_PATH)
    ...
    def read_position_and_image(self):
        ...
        if amount_of_frames == 0:
            ...
            self.center_new = np.array([position[1], position[0]])
            return img, amount_of_frames
